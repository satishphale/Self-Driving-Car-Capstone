...
class TLDetector(object):
    def __init__(self):
        ...
        sub6 = rospy.Subscriber('/image_color', Image, self.img_cb)
    ...
    def loop(self):
        ...
        while not rospy.is_shutdown():
            light_idx, state = self.process_traffic_lights()

            if state == TrafficLight.RED:
                self.upcoming_red_light_pub.publish(Int32(light_idx))
            else:
    ...
    def process_traffic_lights(self):
        ...
        if(self.pose):
            ...
            car_position_idx = self.get_closest_wp_idx(car_pose_x, car_pose_y)
            ...
            if self.lights_tree:
                ...
                if closest_light_dist < MAX_LIGHT_DIST:
                    ...
                    if val < 0:
                        ...
                        light_waypoint_idx = self.get_closest_wp_idx(closest_stop_line_coord[0], closest_stop_line_coord[1])
    ...
    def get_closest_wp_idx(self, x, y):
